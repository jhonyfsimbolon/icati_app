...
class Carousel_Pro extends StatefulWidget {
  ...
  @override
  State createState() => new Carousel_ProState();
}

class Carousel_ProState extends State<Carousel_Pro> {
  ...
  Widget build(BuildContext context) {
    final List<Widget> listImages = widget.images
        .map((netImage) => GestureDetector(
              onTap: () {
                if (netImage.headers["url"] != null ||
                    netImage.headers["url"] != "") {
                  BaseFunction().launchURL(netImage.headers["url"]);
                }
              },
              child: new Container(
          ...
          widget.showIndicator
              ? new Positioned(
                  ...
                  child: new Container(
                    ...
                    padding:
                        new EdgeInsets.only(bottom: widget.indicatorBgPadding),
                    child: new Center(
