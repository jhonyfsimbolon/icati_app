...
import 'package:icati_app/module/login/login_otp_email/pattern/LoginOtpEmailPresenter.dart';
import 'package:icati_app/module/login/login_otp_email/pattern/LoginOtpEmailView.dart';
import 'package:icati_app/module/login/login_otp_email/pattern/LoginOtpEmailWidgets.dart';
import 'package:icati_app/module/menubar/MenuBar.dart';

class LoginOtpEmail extends StatefulWidget {
  String type;

  LoginOtpEmail(this.type);

  @override
  _LoginOtpEmailState createState() => _LoginOtpEmailState();
}

class _LoginOtpEmailState extends State<LoginOtpEmail>
    implements LoginOtpEmailView {
  LoginOtpEmailPresenter _loginOtpEmailPresenter;
  ...
  @override
  void initState() {
    _loginOtpEmailPresenter = LoginOtpEmailPresenter();
    _loginOtpEmailPresenter.attachView(this);
    super.initState();
    _getCredential();
  }
  ...
  _sendOtpEmail() async {
    ...
    if (_formKey.currentState.validate()) {
      _loginOtpEmailPresenter.sendLoginOtpEmail(_emailCont.text);
    } else {
      setState(() {
  ...
  _verificationOtpLogin() {
    ...
    if (_formKey.currentState.validate()) {
      if (_otpCont.text != _dataOtpLogin[0]['otp']) {
        ...
        _loginOtpEmailPresenter.loginOtpEmail(_loginRequest);
      }
    } else {
      setState(() {
        _baseData.isSaving = false;
              ...
              if (_baseData.resendOTP == true) {
                setState(() {
                  ...
                  if (_dataOtpLogin != null) {
                    _loginOtpEmailPresenter.resendLoginOtpEmail(
